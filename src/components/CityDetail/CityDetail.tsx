      ...
      <div className="city-detail__container">
        <div className="city-detail__card">
          ...
          <div className="city-detail__nav">
            {prevCity ? (
              <Link to={`/cities/${prevCity.id}`} className="city-detail__btn city-detail__btn_nav">
                ← Предыдущий
              </Link>
            ) : (
            ...
            <Link to="/" className="city-detail__btn city-detail__btn_home">
              На главную
            </Link>

            {nextCity ? (
              <Link to={`/cities/${nextCity.id}`} className="city-detail__btn city-detail__btn_nav">
                Следующий →
              </Link>
            ) : (
              <button className="city-detail__btn city-detail__btn_disabled" disabled>
